package com.katali.orderservice.web.exception;

import com.katali.orderservice.domain.InvalidOrderException;
import com.katali.orderservice.domain.OrderNotFoundException;
import java.net.URI;
